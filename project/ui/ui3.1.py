...
# 在 result_text_2 之前添加标签


# ... existing code ...

# 在 result_text 之前添加标签
...
def query_results():
    ...
    try:
        ...
        cursor.execute("Truncate table Courses_to_be_taken")
        cursor.execute("Truncate table Courses_taken")
        ...
        #这里我的major要是%MATH%这样的形式，subject要是%COMPSCI%这样的形式，semester要是Fall2024这样的形式，然后就可以替换为参数
        
        #!!!
        plan1,plan2 = f1.funct('%MATH%','Fall2024',"%COMPSCI%")
...
#C:/Users/gigggjjffd/Desktop/work/school stuffs/homeworks/CS310/project/database_design.1.07.sql